...
internal sealed class CSharpIncrementalGeneratorMeasurer<TSourceGenerator>
	where TSourceGenerator : IIncrementalGenerator, new()
{
	...
	internal CSharpIncrementalGeneratorMeasurer()
		=> generator = new TSourceGenerator();

	internal void Initialize(string source, IEnumerable<MetadataReference>? references)
	{
		input = CreateCompilation(source, references);
	...
	private static Compilation CreateCompilation(string source, IEnumerable<MetadataReference>? references)
	{
